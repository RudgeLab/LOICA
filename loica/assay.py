...
class Assay:
    ...
    run(substeps=10, nsr=0, biomass_bg=0, fluo_bg=0, mode=None, ppod=None)
        ...
        'single_cell' - fluorescence measurements of a single cell per strain
    ...
    def run(self, substeps=10, nsr=0, biomass_bg=0, fluo_bg=0, mode=None, ppod=None):
        ...
        with tqdm(total=100) as pbar:
            for sample_id, sample in enumerate(self.samples):
                ...
                # assumes that all strains have equal ppod
                if ppod:
                ...
                for t in range(self.n_measurements):
                    ...
                    if mode == 'track_all':
                    # Record raw measurements of each GeneProduct both intracellularly 
                    # and extracellularly
